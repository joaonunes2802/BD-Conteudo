...
1. Clique no banco de dados ‘PhotoDB’ (último banco de dados da lista).<br>_Script_ no arquivo [photo.relax](../data/photodb.relax).<br>O banco de dados possui o seguinte esquema (chave primária em **negrito**):
